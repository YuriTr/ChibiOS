...
assembly function. */
void _HardFault_exception( void ) __attribute__( ( naked ) );

/* The fault handler implementation calls a function called
prvGetRegistersFromStack(). */
void _HardFault_exception(void)
{
    __asm volatile
    (
        " tst lr, #4                                                \n"
...
void _MemManage_exception(void) {
/*lint -restore*/
...
void HardFault_Handler(void) __attribute__((weak, alias("_HardFault_exception")));
void MemManage_Handler(void) __attribute__((weak, alias("_MemManage_exception")));
